...
sub new
{
    ...
    my $self = {
	client => Muscle::MuscleClient::RpcClient->new,
	url => $url,
	headers => [],
    };
...
sub _validate_version {
    ...
    if ($sMinor > $cMinor) {
        warn "New client version available for Muscle::MuscleClient\n";
    }
    if ($sMajor == 0) {
        warn "Muscle::MuscleClient version is $svr_version. API subject to change.\n";
    }
}
...
package Muscle::MuscleClient::RpcClient;
